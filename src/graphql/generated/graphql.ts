...
/** Model to generic pages on CMS app */
export type GenericPageScheduledInArgs = {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
export type Mutation = {
  ...
  /** Schedule to publish one genericPage */
  schedulePublishGenericPage?: Maybe<GenericPage>;
  ...
  scheduleUnpublishGenericPage?: Maybe<GenericPage>;
...
export type MutationSchedulePublishGenericPageArgs = {
  releaseAt?: Maybe<Scalars['DateTime']>;
  releaseId?: Maybe<Scalars['String']>;
  to?: Array<Stage>;
  where: GenericPageWhereUniqueInput;
...
export type MutationScheduleUnpublishGenericPageArgs = {
  from?: Array<Stage>;
  releaseAt?: Maybe<Scalars['DateTime']>;
  releaseId?: Maybe<Scalars['String']>;
  where: GenericPageWhereUniqueInput;
...
export type ScheduledOperationAffectedDocument = Asset | GenericPage | Place;
...
export type GetGenericPageBySlugQuery = { __typename?: 'Query', genericPage?: { __typename?: 'GenericPage', slug: string, title: string, description: { __typename?: 'RichText', html: string, text: string } } | null | undefined };
...
export type GetPlaceBySlugQuery = { __typename?: 'Query', place?: { __typename?: 'Place', slug: string, name: string, description?: { __typename?: 'RichText', html: string, text: string } | null | undefined, gallery: Array<{ __typename?: 'Asset', url: string, id: string, width?: number | null | undefined, height?: number | null | undefined }> } | null | undefined };
